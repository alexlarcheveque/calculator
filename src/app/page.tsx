...
const calculatorCategories: CalculatorCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Standard Deviation Calculator", path: "/standard-deviation", icon: "📉" },
    ]
  },
  {
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 mb-12 rounded-lg">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">Calculator Hub</h1>
          <p className="text-xl mb-8">Your go-to resource for all types of calculations</p>
              ...
              {category.items.map((calculator) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-gray-900">{calculator.name}</h3>
                    </div>
                  </div>
                </Link>
              ))}
      ...
      <footer className="mt-24 text-center border-t pt-12">
        <p className="text-gray-600 mb-4">
          Choose from our wide range of calculators to help with your financial planning, health tracking, and more.
        </p>
        <p className="text-sm text-gray-500">
          © {new Date().getFullYear()} Calculator Hub. All calculations are for informational purposes only.
        </p>
      </footer>
    </div>
  );
